...
go get tinygo.org/x/drivers/ssd1306
go get tinygo.org/x/tinyfont
go get tinygo.org/x/tinyfont/freemono
go get tinygo.org/x/tinyfont/gophers
...
func main() {
	...
	tinyfont.WriteLine(&display, &freemono.BoldOblique9pt7b, 5, 30, "Radio Pico", white)
	// tinyfont.WriteLine(&display, &freemono.Bold12pt7b, 5, 56, "FM84.3MHz", white)
	tinyfont.WriteLine(&display, &freemono.Bold9pt7b, 5, 56, "FM84.3MHz", white)
	display.Display()
	/*
